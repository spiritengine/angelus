...
class PipeDrain:
    ...
    async def _render_llm_body(
        ...
        prompt = (
            ...
            "- The `informational_since_last_drain` items are UPDATES (world-"
            "change news items, reminders, heads-ups from other systems), NOT "
            "problems. Mention them BRIEFLY at the END, after the operational "
            "summary (e.g. 'Also: a few news items and a reminder'). NEVER lead "
